...
class PlayView(
    ...
    private val world: World = WorldBuilder(Size3D.from2DSize(ViewConfig.World.size, 1)).makeCaves().build(Size3D.from2DSize(ViewConfig.GameArea.size, 1))
